...
+ (void)registerDynamicProperties:
    (NSDictionary * (^)(void))dynamicPropertiesCaculator;

/// 获取 TapAid
+ (void)requestTapAidWithCompletionHandler:
    (void (^)(NSDictionary *_Nullable data, NSURLResponse *_Nullable response,
              NSError *_Nullable error))completionHandler;

/// 获取 TapAid 归因结果
+ (void)requestTapAidAttributionWithCompletionHandler:
    (void (^)(NSDictionary *_Nullable data, NSURLResponse *_Nullable response,
              NSError *_Nullable error))completionHandler;
