...
#                define SWIFT_CLASS(SWIFT_NAME)    \
                    ...
                    __attribute__((                \
                        objc_subclassing_restricted)) SWIFT_CLASS_EXTRA
...
#                define SWIFT_RESILIENT_CLASS_NAMED(SWIFT_NAME)         \
                    __attribute__((objc_class_stub)) SWIFT_CLASS_NAMED( \
                        SWIFT_NAME)
#            else
#                define SWIFT_RESILIENT_CLASS(SWIFT_NAME) \
...
#            define SWIFT_ENUM(_type, _name, _extensibility) \
                ...
                enum SWIFT_ENUM_ATTR(_extensibility)         \
...
#                define SWIFT_ENUM_NAMED(_type, _name, SWIFT_NAME,           \
                    ...
                    enum SWIFT_COMPILE_NAME(SWIFT_NAME)                      \
                        SWIFT_ENUM_ATTR(_extensibility)                      \
                            SWIFT_ENUM_EXTRA _name : _type
#            else
#                define SWIFT_ENUM_NAMED(_type, _name, SWIFT_NAME, \
                                         _extensibility)           \
...
#            pragma clang attribute push(                                     \
                __attribute__((external_source_symbol(                        \
                    language = "Swift", defined_in = "TapTapLoginSDK",        \
...
+ (AccessToken *_Nullable)buildWith:(NSString *_Nonnull)accessTokenJsonString
...
SWIFT_CLASS_PROPERTY(@property(nonatomic, class, readonly, strong)
                         TapLoginSwiftBridgeService *_Nonnull shared;)
+ (TapLoginSwiftBridgeService *_Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)loginWithScopesWithScopes:(NSArray<NSString *> *_Nonnull)scopes
                       completion:
                           (void (^_Nonnull)(NSString *_Nonnull))completion;
- (void)logoutWithCompletion:(void (^_Nullable)(NSString *_Nonnull))completion;
- (void)getCurrentTapAccountWithCompletion:
    (void (^_Nonnull)(NSString *_Nonnull))completion;
@end
...
+ (void)loginWith:(NSArray<NSString *> *_Nonnull)scopes
            viewController:(UIViewController *_Nullable)viewController
    firstPartyLoginOptions:
        (TapFirstPartyLoginOptions *_Nullable)firstPartyLoginOptions
                   handler:(void (^_Nonnull)(TapTapAccount *_Nullable,
                                             NSError *_Nullable, BOOL))handler;
/// 获取登录方式
...
+ (void)LoginWithScopes:(NSArray<NSString *> *_Nonnull)scopes
         viewController:(UIViewController *_Nullable)viewController
                handler:(void (^_Nonnull)(BOOL, NSError *_Nullable,
                                          TapTapAccount *_Nullable))handler;
+ (void)LoginWithScopes:(NSArray<NSString *> *_Nonnull)scopes
                handler:(void (^_Nonnull)(BOOL, NSError *_Nullable,
                                          TapTapAccount *_Nullable))handler;
@end
...
- (nonnull instancetype)initWithJson:
    (NSDictionary<NSString *, id> *_Nonnull)json OBJC_DESIGNATED_INITIALIZER;
- (NSString *_Nonnull)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
