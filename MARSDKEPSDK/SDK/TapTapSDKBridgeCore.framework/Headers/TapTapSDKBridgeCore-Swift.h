...
#            pragma clang attribute push(                                     \
                __attribute__((external_source_symbol(                        \
                    language = "Swift", defined_in = "TapTapSDKBridgeCore",   \
...
SWIFT_CLASS_PROPERTY(@property(nonatomic, class, readonly, strong)
                         TapSDKSwiftBridge *_Nonnull shared;)
...
- (void)registerServiceHandlerWithService:(NSString *_Nonnull)service
                                   method:(NSString *_Nonnull)method
                                  handler:
                                      (void (^_Nonnull)(id _Nonnull,
                                                        id _Nullable))handler;
/// 移除命令处理器
/// \param service 服务名称
///
/// \param method 方法名称
///
- (void)removeHandlerWithService:(NSString *_Nonnull)service
                          method:(NSString *_Nonnull)method;
...
///
- (void)registerHandler:(NSString *_Nonnull)commandJSON
         bridgeCallback:(id<TapSDKSwiftBridgeCallback> _Nullable)bridgeCallback;
/// 处理桥接命令（主入口）
/// \param commandJSON 命令JSON字符串
///
/// \param bridgeCallback 桥接回调对象
///
- (void)processCommand:(NSString *_Nonnull)commandJSON
        bridgeCallback:(id<TapSDKSwiftBridgeCallback> _Nullable)bridgeCallback;
/// 获取已注册的处理器数量（用于调试）
@property(nonatomic, readonly) NSInteger registeredHandlersCount;
/// 获取所有已注册的处理器键名（用于调试）
@property(nonatomic, readonly, copy)
    NSArray<NSString *> *_Nonnull registeredHandlerKeys;
@end
