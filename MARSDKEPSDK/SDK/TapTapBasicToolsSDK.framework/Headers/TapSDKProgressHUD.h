 ...
 */
+ (nullable TapSDKProgressHUD *)HUDForView:(UIView *)view
    NS_SWIFT_NAME(forView(_:));
...
@property(strong, nonatomic, nullable)
    UIColor *contentColor UI_APPEARANCE_SELECTOR;

/**
 * The animation type that should be used when the HUD is shown and hidden.
 */
@property(assign, nonatomic)
    TapSDKProgressHUDAnimation animationType UI_APPEARANCE_SELECTOR;
 ...
 */
@property(assign, nonatomic, getter=isSquare)
    BOOL square UI_APPEARANCE_SELECTOR;
